...
export class TodoItem {
    ...
    get Template() {
        ...
        <div class="d-flex justify-content-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi text-danger bi-x select" onclick="app.userController.deleteTodo('${this.id}')" viewBox="0 0 16 16">
